...
mod test {
    ...
    struct SomeKey {
        key_format_type: KeyFormatType, // the value encountered when deserializing this field
        key_material: KeyMaterial,      // determines the variant to deserialize into this field
    }

    #[test]
    fn test_is_variant_applicable_if_equal() {
        // ============================================================================================================
        // 4. Verify that the if equal condition on KeyMaterial::TransparentSymmetricKey() is matched when
        //    KeyFormatType::TransparentSymmetricKey is used.
        // ============================================================================================================
        let input_var = SomeKey {
            key_format_type: KeyFormatType::TransparentSymmetricKey,
            key_material: KeyMaterial::TransparentSymmetricKey("Blah".into()),
        };
        ...
        let output_var: SomeKey = crate::de::from_slice(serialized_bytes.as_slice()).unwrap();
        assert_eq!(output_var, input_var);
    }
    ...
    fn test_is_variant_applicable_if_in() {
        ...
        let input_var = SomeKey {
            ...
            key_material: KeyMaterial::Bytes(0xFF),
        };
        ...
        let input_var = SomeKey {
            ...
            key_material: KeyMaterial::Bytes(0xF0),
        };
